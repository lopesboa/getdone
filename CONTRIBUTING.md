...
```
 #069  refactor(utils): create url mapper utility function
 #463  chore(webpack): update to isomorphic tools v2
 #493  fix(babel): correct dependencies and polyfills
 #512  feat(app): add react-bootstrap responsive navbar
```
